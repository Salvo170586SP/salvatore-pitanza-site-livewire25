<div>
    <div class="flex justify-between items-center border-b border-zinc-200 dark:border-zinc-600 py-3">
        <h2 class="text-lg font-bold uppercase text-zinc-700 dark:text-white">Skills</h2>
    ...
    <div class="w-full flex justify-between space-x-3  items-center mt-10">
        ...
        @if(!$skillInfo)
        <flux:button icon="plus" wire:navigate href="/admin/skills-home/create-general-description" variant="filled">
            Aggiungi Descrizione
        </flux:button>
        @endif
    </div>
    <div
        class="my-5 border border-zinc-200 dark:border-zinc-700/90 dark:bg-zinc-900/50  overflow-hidden rounded-lg p-5">
        @if($skillInfo)
        <p class="font-medium text-sm  dark:text-slate-200 whitespace-normal overflow-wrap break-words leading-relaxed">
    ...
    <div class="w-full flex justify-between items-center space-x-3 mt-10">
        ...
        <flux:modal.trigger name="add-document">
            <flux:button class="cursor-pointer" icon="plus" variant="filled">Aggiungi Documento</flux:button>
        </flux:modal.trigger>
    </div>
    ...
    <flux:modal name="add-document" class="min-w-[22rem]">
        <div class="space-y-6">
            ...
            <div class="flex gap-2">
                ...
                <flux:button wire:click="addDocument" variant="filled">
                    Carica
                </flux:button>
            </div>
        </div>
                ...
                <tr wire:key="doc-{{$doc->id}}">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex justify-end gap-2">
                            <flux:button href="{{asset('/storage/'.$doc->doc_url)}}" download class="-ms-2"
                                variant="filled" icon="arrow-down-tray">
                                Vedi
                            </flux:button>
    ...
    <div class="w-full flex justify-between items-center space-x-3 mt-10">
        ...
        <flux:button icon="plus" wire:navigate href="/admin/skills-home/created" variant="filled">
            Aggiungi Skills
        </flux:button>
    </div>
    ...
    <div class="border border-zinc-200 dark:border-0 my-5 rounded-lg overflow-hidden">
        <table
            class="min-w-full bg-zinc-200/20 dark:bg-zinc-500/20 divide-y dark:divide-zinc-500/50">
            <thead>
                <tr>
                    <th scope="col" class="px-6 py-5 text-left text-xs font-medium uppercase   w-64">
                        Immagine
