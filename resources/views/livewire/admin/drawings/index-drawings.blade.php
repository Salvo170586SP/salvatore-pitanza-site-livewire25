<div>
    <div class="flex justify-between items-center border-b border-zinc-600 py-3">
        <h2 class="text-xl font-bold uppercase">Disegni</h2>
    ...
    <div class="w-full flex justify-end space-x-3  items-center mt-10">
        <flux:button icon="plus" wire:navigate href="/admin/drawings-home/create">
            Aggiungi
        </flux:button>
    </div>
            ...
            <tr wire:key="draw-{{$draw->id}}">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <div class="flex justify-end gap-2">
                        <flux:button wire:navigate href="/admin/drawings-home/{{$draw->id}}/edit" download class="-ms-2"
