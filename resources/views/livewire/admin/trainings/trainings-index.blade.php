<div>
    <div class="flex justify-between items-center border-b border-zinc-200 dark:border-zinc-600 py-3">
        <h2 class="text-lg font-bold uppercase text-zinc-700 dark:text-white">Percorsi</h2>
    ...
    <div class="w-full flex justify-end mt-12">
        <flux:button icon="plus" wire:navigate href="/admin/trainings-home/created" variant="filled">
            Aggiungi
        </flux:button>
    </div>
                ...
                <tr wire:key="training-{{$training->id}}">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex justify-end gap-2">
                            ...
                            <flux:button wire:navigate href="/admin/trainings-home/{{$training->id}}/edit" class="-ms-2"
                            ...
                            <flux:modal name="delete-profile->[{{$training->id}}]" class="min-w-[22rem]">
                                <div class="space-y-6">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <flux:button wire:click="deleteTraining({{$training->id}})" variant="danger">
                                            Elimina
                                        </flux:button>
                                    </div>
                                </div>
