<div>
    <div class="flex justify-between items-center border-b border-zinc-600 py-3">
        <h2 class="text-xl font-bold uppercase">Esperienze</h2>
    ...
    <div class="w-full flex justify-end mt-12">
        <flux:button icon="plus" wire:navigate href="/admin/experiences-home/created">
            Aggiungi
        </flux:button>
    </div>
            ...
            <tr wire:key="experience-{{$experience->id}}">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <div class="flex justify-center gap-2">
                        ...
                        <flux:modal name="view-experience-[{{$experience->id}}]" class="min-w-[500px] max-w-[700px]">
                            <div class="space-y-6">
                        ...
                        <flux:button wire:navigate href="/admin/experiences-home/{{$experience->id}}/edit" class="-ms-2" variant="filled"
                            icon="pencil">
                            Modifica
                        </flux:button>
                        ...
                        <flux:modal name="delete-experience->[{{$experience->id}}]" class="min-w-[22rem]">
                            <div class="space-y-6">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <flux:button wire:click="deleteExperience({{$experience->id}})" variant="danger">Elimina
                                    </flux:button>
                                </div>
                            </div>
                        </flux:modal>
