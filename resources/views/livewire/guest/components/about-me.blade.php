<div>
    <section id="about" class="w-full container mx-auto flex flex-col py-10 md:py-20 items-center text-white border-b border-zinc-800">
        ...
        <div class="flex justify-center items-center flex-col lg:flex-row text-center gap-5 px-4 md:px-0">
            ...
            <figure class="w-[250px] h-[250px]  md:me-20  overflow-hidden rounded-[15px]">
                <img src="{{-- @if ($biography->img_url) {{ asset('storage/' . $biography->img_url) }} @else --}}  assets/imgs/unnamed.png  {{-- @endif --}}"
            ...
            <div
                ...
                <p class="font-semibold">
                    ...
                    <span class="text-zinc-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui modi ipsam
                        sit, facilis impedit dolore ipsum fuga blanditiis veniam ullam officia laborum. Delectus
                        aspernatur earum dolore officiis dignissimos dicta nam.</span>
                </p>
